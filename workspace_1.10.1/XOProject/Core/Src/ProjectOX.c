...
struct GameOver StatusGame() {
	...
	WIN1 = winner[1 - 1] == 1 && winner[2 - 1] == 1 && winner[3 - 1] == 1 ?
			1 : 0; 	//123
	WIN1 = winner[4 - 1] == 1 && winner[5 - 1] == 1 && winner[6 - 1] == 1 ?
			1 : 0; 	//456
	WIN1 = winner[7 - 1] == 1 && winner[8 - 1] == 1 && winner[9 - 1] == 1 ?
			1 : 0; 	//789
	WIN1 = winner[1 - 1] == 1 && winner[5 - 1] == 1 && winner[9 - 1] == 1 ?
			1 : 0; 	//159
	WIN1 = winner[3 - 1] == 1 && winner[5 - 1] == 1 && winner[7 - 1] == 1 ?
			1 : 0; 	//357
	WIN1 = winner[1 - 1] == 1 && winner[4 - 1] == 1 && winner[7 - 1] == 1 ?
			1 : 0; 	//147
	WIN1 = winner[2 - 1] == 1 && winner[5 - 1] == 1 && winner[8 - 1] == 1 ?
			1 : 0; 	//258
	WIN1 = winner[3 - 1] == 1 && winner[6 - 1] == 1 && winner[9 - 1] == 1 ?
			1 : 0; 	//369

	WIN2 = winner[1 - 1] == 2 && winner[2 - 1] == 2 && winner[3 - 1] == 2 ?
			1 : 0; 	//123
	WIN2 = winner[4 - 1] == 2 && winner[5 - 1] == 2 && winner[6 - 1] == 2 ?
			1 : 0; 	//456
	WIN2 = winner[7 - 1] == 2 && winner[8 - 1] == 2 && winner[9 - 1] == 2 ?
			1 : 0; 	//789
	WIN2 = winner[1 - 1] == 2 && winner[5 - 1] == 2 && winner[9 - 1] == 2 ?
			1 : 0; 	//159
	WIN2 = winner[3 - 1] == 2 && winner[5 - 1] == 2 && winner[7 - 1] == 2 ?
			1 : 0; 	//357
	WIN2 = winner[1 - 1] == 2 && winner[4 - 1] == 2 && winner[7 - 1] == 2 ?
			1 : 0; 	//147
	WIN2 = winner[2 - 1] == 2 && winner[5 - 1] == 2 && winner[8 - 1] == 2 ?
			1 : 0; 	//258
	WIN2 = winner[3 - 1] == 2 && winner[6 - 1] == 2 && winner[9 - 1] == 2 ?
			1 : 0; 	//369

	Status =
			winner[1 - 1] != 0 && winner[2 - 1] != 0 && winner[3 - 1] != 0
					&& winner[6 - 1] != 0 && winner[5 - 1] != 0
					&& winner[4 - 1] != 0 && winner[7 - 1] != 0
					&& winner[8 - 1] != 0 && winner[9 - 1] != 0 ? 1 : 0;
